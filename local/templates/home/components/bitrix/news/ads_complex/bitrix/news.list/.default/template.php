...
<?foreach($arResult["ITEMS"] as $arItem):?>
    ...
    <div class="col-md-6 col-lg-4 mb-4" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
        <a href="<?=$arItem["DETAIL_PAGE_URL"]?>" class="prop-entry d-block">
            ...
            <div class="prop-text">
                <div class="inner">
                    <span class="price rounded"><?=$arItem['DISPLAY_PROPERTIES']['PRICE']['VALUE']?> Р</span>
                ...
                <div class="prop-more-info">
                    <div class="inner d-flex">
                        ...
                        <div class="col">
                            <span>Garages:</span>
                            <strong><?if ($arItem['DISPLAY_PROPERTIES']['GARAGE']['VALUE_ENUM_ID'] == 6) echo 'Yes'; else echo 'No';?></strong>
                        </div>
                    </div>
                </div>
            </div>
